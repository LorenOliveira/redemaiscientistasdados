<?php
	...
	if (isset($_POST['criar'])) {
		...
		if ($do_email_check >= 1){
			...
			$query = "INSERT INTO users (`nome`, `sobrenome`, `email`, `password`, `cidade`, `estado`, `salario`, `instrucao`, `empresa`, `data`) VALUES ('$nome', '$sobrenome', '$email', '$pass', '$cidade', '$estado', '$salario', '$instrucao', '$empresa', '$data')";
